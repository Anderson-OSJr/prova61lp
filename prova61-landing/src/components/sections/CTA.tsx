...
export function CTA() {
  return (
    <section id="contato" className="py-24 bg-navy-950">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="relative bg-gradient-to-br from-navy-900 to-navy-800 border border-white/10 rounded-3xl p-12 md:p-16 overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  size="lg"
                  className="bg-gold-600 hover:bg-gold-700 text-navy-950 font-semibold text-lg px-10 py-7 rounded-xl group transition-all duration-300 hover:scale-105"
                  asChild
                >
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-gold-600/30 text-white hover:bg-gold-600/10 rounded-xl px-8 text-lg"
                  asChild
                >
